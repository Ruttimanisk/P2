...
UserSchema.virtual("lifespan").get(function() {
    return "" +(this.date_of_birth ? DateTime.fromJSDate(this.date_of_birth).toLocaleString({ weekday: 'long', month: 'short', day: '2-digit' }) : '') +
        (this.date_of_death ? " - " + DateTime.fromJSDate(this.date_of_death).toLocaleString({ weekday: 'long', month: 'short', day: '2-digit' }) : '');
});
