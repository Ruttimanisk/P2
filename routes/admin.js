...
router.get('/edit_employye_schedule', requireAuth, userschedule_controller.renderEditSchedule);

router.post('/edit_employee_schedule/save', requireAuth, userschedule_controller.saveEditedSchedule);
